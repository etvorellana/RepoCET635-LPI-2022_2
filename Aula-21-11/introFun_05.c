...
/*
    ...
    com ajuda dos parâmetros de entrada da função. Veja 
    como funciona o escopo das variáveis de acordo com o 
    bloco sintáctico onde são declaradas.
...
int main(void)
{
    ...
    // ... ou valores explícitos ...
    num = leituraDeValor(0, 12);
    printf("O valor fornecido é %d\n", num);
    // ... ou um pouco de cada (;-)
    num = leituraDeValor(0, limSupLocal);
    printf("O valor fornecido é %d\n", num);
...
int leituraDeValor(int limInfPar, int limSupPar)
{
    ...
    printf("Limites definidos noa parâmetros: %d - %d\n", limInfPar, limSupPar); 
    do{
...
./"introFun_05" 
Limites iniciais: 0 - 12
Limites definidos noa parâmetros: 0 - 12
